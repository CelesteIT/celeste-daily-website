function CreateWhatsappChatWidget(option = {
    ...
    function initWidget(){
        ...
        jQuery('body').append(`<div id="whatsapp_chat_widget">
            <div id="wa-widget-send-button">
                ...
                <div style="color: white; font-size: 18px; font-family: sans-serif;">${option.chatButtonSetting.ctaText}Message Us</div>
            </div>
        </div>`);
        jQuery('#whatsapp_chat_widget').append(`
            <div class='wa-chat-box'>
                ...
                <div class='wa-chat-box-send'>
                    ...
                    <div class='wa-chat-box-poweredby'>Powerded By <a href="https://yenasys.com/" target="_blank" style="color: #006eff6e;">www.yenasys.com</a></div>
                </div>
            </div>
        `);
    ...
    var styles = `
        ...
        #wa-widget-send-button {
            ...
            padding-left: ${option.chatButtonSetting.ctaText?"15px":"22px"};
            padding-right: ${option.chatButtonSetting.ctaText?"15px":"24px"};
            position: fixed !important;
            z-index: 16000160 !important;
            bottom: 0 !important;
